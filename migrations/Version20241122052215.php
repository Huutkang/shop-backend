 ...
 */
final class Version20241122052215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE group_permissions (group_id INT NOT NULL, permission_id INT NOT NULL, PRIMARY KEY(group_id, permission_id))');
        ...
        $this->addSql('CREATE TABLE user_group_members (user_id INT NOT NULL, group_id INT NOT NULL, PRIMARY KEY(user_id, group_id))');
        $this->addSql('CREATE INDEX IDX_2D2E2BA3A76ED395 ON user_group_members (user_id)');
        $this->addSql('CREATE INDEX IDX_2D2E2BA3FE54D947 ON user_group_members (group_id)');
        $this->addSql('CREATE TABLE user_groups (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_953F224D5E237E06 ON user_groups (name)');
        $this->addSql('CREATE TABLE user_permissions (user_id INT NOT NULL, permission_id INT NOT NULL, PRIMARY KEY(user_id, permission_id))');
        ...
        $this->addSql('ALTER TABLE group_permissions ADD CONSTRAINT FK_855D3AEFE54D947 FOREIGN KEY (group_id) REFERENCES user_groups (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE user_group_members ADD CONSTRAINT FK_2D2E2BA3A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_group_members ADD CONSTRAINT FK_2D2E2BA3FE54D947 FOREIGN KEY (group_id) REFERENCES user_groups (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_group_members DROP CONSTRAINT FK_2D2E2BA3A76ED395');
        $this->addSql('ALTER TABLE user_group_members DROP CONSTRAINT FK_2D2E2BA3FE54D947');
