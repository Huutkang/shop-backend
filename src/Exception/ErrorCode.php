...
class ErrorCode {
    ...
    const E1003 = ['code' => 1003, 'message' => 'Tài khoản không tồn tại', 'httpStatus' => 404];
    const E1004 = ['code' => 1004, 'message' => 'Mật khẩu không chính xác', 'httpStatus' => 401];
    const E1005 = ['code' => 1005, 'message' => 'Tài khoản bị khóa', 'httpStatus' => 403];
